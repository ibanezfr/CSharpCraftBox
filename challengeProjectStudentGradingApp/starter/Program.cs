...
- Use an algorithm within the outer loop to calculate the average exam score for
each student.
...
Emma		  85.6		    90.4	A-	      89 (4.8 pts)
Logan		  91.2		    93	  A	        96 (1.8 pts)
...
foreach (string name in studentNames)
{
    ...
    */
    ...
    currentExtraGrade = (decimal)(sumExtraScores) / extraProjectsCtr;
    extraProjectsCtr = 0;
    ...
    Console.Write($"{currentStudent}\t\t{currentExamGrade}");
    Console.Write($"\t\t{currentStudentGrade}");
    Console.Write($"\t{currentStudentLetterGrade}\t{currentExtraGrade} ");
    Console.WriteLine($"({currentStudentGrade - currentExamGrade} pts)");
}
